...
void Gui::init()
{
	...
	pointbox1 = new Column(sf::Vector2f{150.f, 150.f}, "assets/arial.ttf");
	pointbox2 = new Column(sf::Vector2f{250.f, 150.f}, "assets/arial.ttf");
	pointbox3 = new Column(sf::Vector2f{350.f, 150.f}, "assets/arial.ttf");
	pointbox4 = new Column(sf::Vector2f{450.f, 150.f}, "assets/arial.ttf");
	pointbox5 = new Column(sf::Vector2f{50.f, 250.f}, "assets/arial.ttf");
	pointbox6 = new Column(sf::Vector2f{150.f, 250.f}, "assets/arial.ttf");
	pointbox7 = new Column(sf::Vector2f{250.f, 250.f}, "assets/arial.ttf");
	pointbox8 = new Column(sf::Vector2f{350.f, 250.f}, "assets/arial.ttf");
	pointbox9 = new Column(sf::Vector2f{450.f, 250.f}, "assets/arial.ttf");
	pointbox10 = new Column(sf::Vector2f{50.f, 350.f}, "assets/arial.ttf");
	pointbox11 = new Column(sf::Vector2f{150.f, 350.f}, "assets/arial.ttf");
	pointbox12 = new Column(sf::Vector2f{250.f, 350.f}, "assets/arial.ttf");
	pointbox13 = new Column(sf::Vector2f{350.f, 350.f}, "assets/arial.ttf");
	pointbox14 = new Column(sf::Vector2f{450.f, 350.f}, "assets/arial.ttf");
	pointbox15 = new Column(sf::Vector2f{50.f, 450.f}, "assets/arial.ttf");
	pointbox16 = new Column(sf::Vector2f{150.f, 4500.f}, "assets/arial.ttf");
	pointbox17 = new Column(sf::Vector2f{250.f, 450.f}, "assets/arial.ttf");
	pointbox18 = new Column(sf::Vector2f{350.f, 450.f}, "assets/arial.ttf");
	pointbox19 = new Column(sf::Vector2f{450.f, 450.f}, "assets/arial.ttf");
